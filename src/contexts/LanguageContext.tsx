...
const translations = {
  en: {
    ...
    signOut: 'Sign Out',
    loginToStudentPortal: 'Login to Student Portal',
    loginToStudentPortalDescription: 'Login to access your personalized student dashboard, grades, and messages',
    quickGradeCheckDescription: 'Quick grade check without login (public access)',
  ...
  am: {
    ...
    signOut: 'ውጣ',
    loginToStudentPortal: 'ወደ የተማሪ ፖርታል ግባ',
    loginToStudentPortalDescription: 'የተበጀ የተማሪ ዳሽቦርድ፣ ውጤቶች እና መልዕክቶችን ለመድረስ ይግቡ',
    quickGradeCheckDescription: 'ያለመግባት ፈጣን የውጤት ፍተሻ (ለሕዝብ ክፍት)',
    poweredBy: 'በ',
